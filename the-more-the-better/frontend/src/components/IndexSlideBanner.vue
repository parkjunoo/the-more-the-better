<template>
    <div class="section">
        <section class="webdesigntuts-workshop"  v-on:keyup.down="selectValue('down')" v-on:keyup.up="selectValue('up')">
            <form action="" method="">          
                <input class="s" type="search" placeholder="배달하고 싶으신 지점을 찾아주세요!" v-on:input="search=event.target.value">             
            ...
            <!--가로-->
                        ...
                        src="https://www.fedrigonipapers.com/sites/default/files/styles/papers_default/public/2018-09/_MG_6220_SirioBlackBlack_BlackBlack.jpg?itok=nKQsMSry"
                        alt="First slide">
